...
const Home = () => {
  return (
    <section name='home'
    className="w-full background-image bg-home bg-cover bg-left md:bg-center bg-no-repeat md:py-20"
  >
    <div className="max-w-[1200px] mx-auto px-4 flex items-center min-h-screen">
      <div className="md:w-2/4 text-center md:text-left background-image-home">
        <h2
